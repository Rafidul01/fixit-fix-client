    ...
    <div className="container mx-auto">
      ...
      <div className="relative">
        <img
          ...
          alt=""
        />
        <div className="absolute top-[93px] left-[98px] lg:top-60 lg:left-60 md:top-44 md:left-44 ">
          <h1 className="text-[0.35rem] md:text-base lg:text-xl max-w-[120px] md:max-w-[350px] lg:max-w-[450px] font-bold -rotate-1">
