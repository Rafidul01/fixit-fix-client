  ...
  return (
    <div className="bg-base-100  border-t shadow-2xl border-[#74C138] text-base-content  font-lato">
      <footer className="footer p-10 container mx-auto items-center">
        ...
        <nav>
          <h6 className="footer-title text-[#74C138]" >Contact Info</h6>
          <Link className="link link-hover"><span className="font-bold">Head Office : </span>Chittagong, Bangladesh</Link>
          <Link  className="link link-hover"><span className="font-bold">Branch : </span>Dhaka, Bangladesh</Link>
